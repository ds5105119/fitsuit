      ...
      <main className="mt-16 lg:mt-20 min-h-[calc(100vh-4rem)] bg-neutral-50 text-neutral-900">
        <div className="mx-auto max-w-5xl px-6 py-10">
          <div className="border-b border-neutral-200 pb-4">
            ...
            <p className="mt-1 text-sm text-neutral-600">로그인 후 주문/배송 조회가 가능합니다.</p>
          </div>
          <div className="mt-8 text-sm text-neutral-500">로그인 팝업이 자동으로 열리지 않았다면 새로고침 해주세요.</div>
        </div>
      </main>

      <LoginDialog defaultOpen callbackUrl={next} onCloseHref="/" />
    </>
  );
}

  ...
  return (
    <LenisProvider>
      <main className="min-h-screen">
        ...
        <section className="mx-auto py-36 pb-24 lg:pb-36 lg:pt-56 bg-black">
          <div className="grid gap-10 max-w-6xl px-6 items-center mx-auto">
            <div className="space-y-5">
              <p className="text-base font-medium leading-relaxed text-white sm:text-sm">Vision</p>
        ...
        <section className="w-full text-black py-36">
          <div className="mx-auto flex flex-col gap-4 px-6">
            <div className="max-w-3xl mx-auto text-lg flex flex-col items-center">
              <div>
                <p className="text-base font-medium leading-relaxed sm:text-sm text-center">Custom Made</p>
                <p className="text-3xl font-bold leading-relaxed sm:text-4xl text-center pt-4">
                  &lsquo;가치&rsquo;를 찾는 여정,
                  <br />
                  대한민국 양복 명장이 도와드리겠습니다.
                </p>
                <p className="text-sm lg:text-base leading-relaxed pt-6">
        ...
        <section className="mx-auto py-36 lg:py-56">
          <div className="grid gap-10 max-w-6xl px-6 items-center mx-auto">
            <div className="space-y-5">
              <p className="text-base font-medium leading-relaxed sm:text-sm">Vision</p>
              <p className="text-5xl font-light leading-tight sm:text-7xl font-instrument">
                We create bespoke garments that merge design vision with master craftsmanship.
              </p>
              <p className="text-sm leading-relaxed text-black/70 sm:text-base lg:w-[70%] break-keep">
                비스포크 수트는 기성복이나 일반 맞춤(MTM)과는 차원이 다릅니다. 고객의 직업과 자세, 생활 습관, 그리고 취향까지 세밀하게 반영하여 전용 패턴을
                새롭게 제작하며, 원단과 안감, 단추, 세부 디자인까지 모두 고객이 직접 선택할 수 있습니다. 그 결과 완성되는 수트는 세상에 단 하나뿐인, 오직 한
                사람만을 위한 작품입니다.
              </p>
                ...
                <div key={step.title} className={cn("lg:w-[75%] grid items-center gap-10 lg:gap-0 lg:grid-cols-9", idx % 2 == 0 && "ml-auto")}>
                  <div className={cn("flex flex-col gap-6 lg:col-span-5 lg:pr-10")}>
                    <div className="flex items-start">
                      <p className="text-3xl leading-relaxed sm:text-5xl font-instrument ">{step.title}</p>
                      <p className="text-sm sm:font-base font-instrument italic">(0{idx})</p>
                    </div>
                    <p className="text-sm leading-relaxed text-black/70 sm:text-base whitespace-pre-line">{step.subtitle}</p>
                  </div>
                  <div className={cn("relative aspect-square w-full overflow-hidden lg:col-span-4")}>
